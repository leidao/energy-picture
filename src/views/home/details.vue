 ...
 * @LastEditTime: 2025-01-14 17:35:42
-->
<template>
  <el-dialog v-model="open" width="1200" :footer="null" align-center>
    <template #header>
      <div class="flex items-center">
        ...
        <div class="text-#3D3D3D text-20px font-500 ml-8px">商水县分布式光伏电站运行信息</div>
      </div>
    </template>
      ...
      <div class="bg-#F1F1F1 px-10px">
        <el-form ref="ruleFormRef" :inline="true" :model="formInline" class="demo-form-inline" label-suffix=":">
          <el-row class="pt-16px">
            <el-col :span="8">
              <el-form-item label="光伏用户" prop="trName">
                <span>38户</span>
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="变电站数量" prop="trName">
                <span>{{ details.substations }}</span>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item label="主变数量" prop="trName">
                <span>31</span>
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="所属区域" prop="trName">
